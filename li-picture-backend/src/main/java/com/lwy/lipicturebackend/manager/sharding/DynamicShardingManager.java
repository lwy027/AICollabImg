package com.lwy.lipicturebackend.manager.sharding;
...
public class DynamicShardingManager {
    ...
    private void updateShardingTableNodes() {
        ...
        // li_picture.picture_112321321,li_picture.picture_1123213123
        String newActualDataNodes = tableNames.stream().map(tableName -> "li_picture." + tableName) // 确保前缀合法
