...
//            }
        ...
        UploadPictureResult uploadPictureResult = pictureUploadTemplate.uploadPicture(inputSource, uploadPathPrefix);        // 构造要入库的图片信息
    ...
    @Override
    public QueryWrapper<Picture> getQueryWrapper(PictureUploadRequest pictureQueryRequest) {
        return null;
    }
