package com.lwy.lipicturebackend.manager.auth;
...
import static com.lwy.lipicturebackend.constant.UserConstant.USER_LOGIN_STATE;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    public List<String> getPermissionList(Object loginId, String loginType) {
        ...
        if (spaceUserId != null) {
            ...
            SpaceUser loginSpaceUser = spaceUserService.lambdaQuery().eq(SpaceUser::getSpaceId, spaceUser.getSpaceId()).eq(SpaceUser::getUserId, userId).one();
        ...
        if (space.getSpaceType() == SpaceTypeEnum.PRIVATE.getValue()) {
            ...
            spaceUser = spaceUserService.lambdaQuery().eq(SpaceUser::getSpaceId, spaceId).eq(SpaceUser::getUserId, userId).one();
            if (spaceUser == null) {
                return new ArrayList<>();
            }
            return spaceUserAuthManager.getPermissionsByRole(spaceUser.getSpaceRole());
